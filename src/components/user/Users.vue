<template>
  <div>
    ...
    <el-card>
      ...
      <!--搜索与添加区域-->
      <el-table :data="userlist" border striped>
        ...
        <el-table-column prop="mg_state" label="状态">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.mg_state" @change="userStatecChanged(scope.row)">
            </el-switch>
          </template>
        </el-table-column>
    ...
    <!--添加用户的对话框-->
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="40%" @closed="addDialogClosed">
      <!--内容主体区域-->
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisible" width="30%">
      ...
      <!--底部区域-->
      <span slot="footer" class="dialog-footer">
        <el-button @close="editDialogClose" @click="editDialogVisible= false">取 消</el-button>
        <el-button type="primary" @click="saveEditDialog">确 定</el-button>
      </span>
    </el-dialog>
    <!--分配角色的对话框-->
    <el-dialog title="分配角色" :visible.sync="setDialogVisible" width="50%" @closed="SetDiaglogClosed">
      <div>
